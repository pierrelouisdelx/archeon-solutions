...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_team_socials_platform" AS ENUM('linkedin', 'github', 'x', 'website', 'scholar');
  CREATE TYPE "public"."enum_services_icon" AS ENUM('Eye', 'Brain', 'HeartPulse', 'Cpu', 'Microscope', 'BarChart3', 'Sparkles', 'Layers');
  CREATE TYPE "public"."enum_services_span" AS ENUM('md:col-span-1', 'md:col-span-2');
  CREATE TYPE "public"."enum_redirects_to_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_site_settings_socials_platform" AS ENUM('linkedin', 'github', 'x', 'youtube');
  ...
  CREATE TABLE "team_socials" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"platform" "enum_team_socials_platform",
  ...
  CREATE TABLE "services" (
  	...
  	"description" jsonb,
  	"icon" "enum_services_icon" DEFAULT 'Eye' NOT NULL,
  	"span" "enum_services_span" DEFAULT 'md:col-span-1',
  	"order" numeric DEFAULT 0,
  	"meta_title" varchar,
  	"meta_description" varchar,
  	"meta_image_id" integer,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Archeon Solutions' NOT NULL,
  	"tagline" varchar,
  	"description" varchar,
  	"default_og_image_id" integer,
  	"contact_email" varchar,
  	"organization_legal_name" varchar DEFAULT 'Archeon Solutions',
  ...
  CREATE TABLE "homepage" (
  	...
  	"about_eyebrow" varchar DEFAULT 'About Us',
  ...
  ALTER TABLE "_projects_v" ADD CONSTRAINT "_projects_v_version_hero_video_id_media_id_fk" FOREIGN KEY ("version_hero_video_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_articles_v" ADD CONSTRAINT "_articles_v_version_author_id_team_id_fk" FOREIGN KEY ("version_author_id") REFERENCES "public"."team"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "affiliations" ADD CONSTRAINT "affiliations_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_affiliations_fk" FOREIGN KEY ("affiliations_id") REFERENCES "public"."affiliations"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "_projects_v_version_version_hero_video_idx" ON "_projects_v" USING btree ("version_hero_video_id");
  ...
  CREATE INDEX "affiliations_logo_idx" ON "affiliations" USING btree ("logo_id");
  CREATE INDEX "affiliations_updated_at_idx" ON "affiliations" USING btree ("updated_at");
  CREATE INDEX "affiliations_created_at_idx" ON "affiliations" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_affiliations_id_idx" ON "payload_locked_documents_rels" USING btree ("affiliations_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_team_socials_platform";
  DROP TYPE "public"."enum_services_icon";
  DROP TYPE "public"."enum_services_span";
